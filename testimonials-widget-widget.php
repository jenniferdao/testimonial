...
/*
 * In order the widget to function, widgets_init will allow for the actual widget to load properly.
 */
add_action( 'widgets_init', 'testimonials_widgets' );

/*
 * This is to allow for the widget to register. 
 */
...
/*
 * Below is defined as the widget class which will be applied to all classes with the same name.
 */
class testimonials_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		// This is a check box metohod that allows the back end user would like for the author to appear on the front end of the widget
		...
		// Alows for a check box type of input to be displayed on back end of WordPress to give user the ability to show source or not.
