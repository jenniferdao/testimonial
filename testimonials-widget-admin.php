...
// This will start the actual functionality and will call upon the testimonial widget's back end menu for the user
...
/** Below will actually apply the function of inputting a testimonial widget admin footer
 *  It will also allow for a java script type text to allow for the checkbox elements to have two form options
 *  The two options that the form will call upon are Boolean's True or False, done through the click attribute
*/ 
...
//This add_action will call on the retrieval of the testimonial widget's admin footer to keep it consistent
